...
var quotes = []string{
	"What fuckin' book?",
	"Can you shoot?",
	"You say that like it's a bad thing. Carl Johnson: Are you sure, man?",
	"I'm gonna stick. What you got?",
	"Not good. You got, uh, 47. Carl Johnson: You should have run away!",
	"What? Oh, Maccer? He got a little problem he can't control.",
	"He can't stop, you know, givin' himself a little bit. Carl Johnson: Yeah.",
	"Quit it!",
	"Enough, man!",
	"It seems impossible to keep a secret around here! I would have thought the size of the room would keep the numbers down.",
	"I appreciate your input, but please, fuck off. Carl Johnson: Oh, OK, you can stay.",
	"OK, look, I'm going to go shut off the city's power source. Woozie, look after these fools for me. Carl Johnson: The K's jammed!",
	"OH SHIT!",
	"Hey, what up Z!",
	"...Why?",
	...
	"Ah, so I've heard.",
	"Holy Motherfucker! Carl Johnson: I'm here to bury my Moms. You know that.",
	...
	"You know what? I'm tired of your fucking little jobs. Carl Johnson: Hello?",
	"Aw, Sweet!",
	"All right you hold tight, I'll be right there.",
	"So what was that little job you was talking about, Toreno?",
	"Fittin' to hit the block, see what's happening. Carl Johnson: No. I can take rejection. Carl Johnson: Where'd you get that? Carl Johnson: What's the matter? You lost? Need a hand?",
	"Who?",
	...
	"Hey, ain't that exactly what you do? Carl Johnson: Why am I here?",
	...
	"Can you help me now? Carl Johnson: I'm on it, man, I swear!",
	"Shit, dude, okay! Okay! I swear, man, I'm gonna be the best pilot!",
	"Wait! Please, man!",
	"OK, man, I get the message. Carl Johnson: Whatever, man. Carl Johnson: Cool, what's the problem then?",
	"Aw, shit.",
	"C'mon, dude, what's all that about?",
	"Why?",
	"A what?",
	"Where are you? You givin' me the heebie jeebies, man!",
	"That ain't nothing cool, man! Just leave me alone. You're bad news! Carl Johnson: Huh, man, kill Government agents?",
	"That's amazing. You didn't even touch them.",
	"Damn! That nigga's fucked up!",
	"Bang! Bang! Bang!",
	"Damn! Did you buy your license? Carl Johnson: Who is this?",
	"Who? Carl Johnson: 'Cause you been dealin' drugs, man. Since the age of ten. Ha, ha, ha.",
	"'Cause you put your hands on that teacher for wearin' Ballas colours. Ha, ha, ha. Carl Johnson: I'm a well-dressed maniac, fool!",
	"Good, maybe you won't go berserk then. Carl Johnson: 'Sup?",
	"Whassup, Sweet, what you want? Carl Johnson: You need to lay OFF the coffee!",
	"That's going to my retirement fund",
	"I smell like money. Carl Johnson: I hope you're clean, bitch.",

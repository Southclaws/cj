...
type Config struct {
	...
	DefaultCooldown time.Time `split_words:"true" required:"true"`  // the default command cooldown if not set in DB
	...
	AdministrativeChannel string `split_words:"true" required:"true"` // DEPRECATED
	PrimaryChannel        string `split_words:"true" required:"true"` // DEPRECATED
	Admin                 string `split_words:"true" required:"true"` // DEPRECATED
}

...
type Config struct {
	...
	DashboardEnabled       bool          `split_words:"true" required:"false"`
	DashboardListenAddr    string        `split_words:"true" required:"false"`
	DashboardPublicURL     string        `split_words:"true" required:"false"`
	DashboardAllowedHosts  string        `split_words:"true" required:"false"`
	DashboardLogBufferSize int           `split_words:"true" required:"false" default:"5000"`
	DashboardLogRetention  time.Duration `split_words:"true" required:"false" default:"1h"`
}
